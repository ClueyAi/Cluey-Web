...
const Interests = ({ setInterestsItens }) => {
  ...
  const buttons = [
    ...
    { id: 2, title: locale.preferences.interests.itens.ia, color: '#FFBF00', selected: false },
    ...
    { id: 5, title: locale.preferences.interests.itens.c_sharp, color: '#1400FF', selected: false },
    ...
    { id: 10, title: locale.preferences.interests.itens.javascript, color: '#1400FF' ,selected: false },
