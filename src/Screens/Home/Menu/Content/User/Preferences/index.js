...
const Preferences = ({ setVPreferences }) => {
  ...
  const {user, putPreferences} = useContext(FirebaseContext);
      ...
      <Modal transparent={true}>
        <PreferencesContainer theme={theme}>
          <PreferencesContent theme={theme} style={shadow}>
            ...
            <Interests interests={interests} setInterestsItens={setInterestsItens} />
            <PreferencesAction>
      ...
      <Modal transparent={true}>
        <PreferencesContainer theme={theme}>
          <PreferencesContent theme={theme} style={shadow}>
            ...
            <Focus focus={focus} setFocusItens={setFocusItens} />
            <PreferencesAction>
